...
exports.getAttacksHandler = getAttacksHandler;
exports.getAttackStatsHandler = getAttackStatsHandler;
exports.getTopAttackersHandler = getTopAttackersHandler;
exports.getGeoStatsHandler = getGeoStatsHandler;
exports.getAttacksBySensorHandler = getAttacksBySensorHandler;
exports.searchAttacksByIpHandler = searchAttacksByIpHandler;
exports.getAttackDetailHandler = getAttackDetailHandler;
const attackService = __importStar(require("../services/attack.service"));
...
async function getAttacksHandler(request, reply) {
    try {
        ...
        const result = await attackService.getAttacksByDateRange(start, end, filters);
        // Format response with sensor information
        const attacksWithSensors = await Promise.all(result.attacks.map(async (attack) => {
            ...
            return {
                ...
                sensor: sensor
                    ...
                    : null,
                location: attack.country || attack.city
                    ? {
 ...
 */
async function getAttackStatsHandler(request, reply) {
    try {
 ...
 */
async function getTopAttackersHandler(request, reply) {
    try {
        ...
        const topAttackers = await attackService.getTopAttackers(parsedLimit, start, end);
 ...
 */
async function getGeoStatsHandler(request, reply) {
    try {
        const { startDate, endDate } = request.query;
        let start;
        let end;
 ...
 */
async function getAttacksBySensorHandler(request, reply) {
    try {
        ...
        request.log.info({ sensorId: parsedSensorId, limit: parsedLimit, offset: parsedOffset }, 'Fetching attacks for sensor');
        const result = await attackService.getAttacksBySensor(parsedSensorId, parsedLimit, parsedOffset);
 ...
 */
async function searchAttacksByIpHandler(request, reply) {
    try {
 ...
 */
async function getAttackDetailHandler(request, reply) {
    try {
